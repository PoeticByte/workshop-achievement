...
STRINGS.ACHIVABILITYDSPC = {
  ["thornss"] = "Reflect part of the damage back to attackers when you are hit",
  ["woodieability"] = "Gain Woodie's werebeast transformation: fast chopping, more damage and damage reduction while transformed",
  ["speedup"] = "Increase movement speed by 5% per level, stacks multiple times",
  ["absorbup"] = "Increase defense (damage absorption) by 5% per level, stacks",
  ...
  ["goodman"] = "Wearing the Bee Queen Crown makes bees, pigs, bunnymen, spiders and hounds follow you as their leader",
  ["fishmaster"] = "Fish bite instantly while fishing, a near-guaranteed catch",
  ["chopmaster"] = "Fell an entire tree in a single swing",
  ["goldminer"] = "Break rocks and mineable nodes in a single hit",
  ["cookmaster"] = "Cook faster and gain Warly's chef-related abilities",
  ["pickmaster"] = "Get double yield when picking and harvesting",
  ["nomoist"] = "Immune to wetness; you never get wet, even in the rain",
  ["icebody"] = "Adapt to seasons: no cold in spring/winter, no heat in summer/autumn",
  ["firebody"] = "Immune to fire, regain sanity near fire, craft a lighter & Bernie + Willow skills: lighter/fire upgrades, fireballs and Bernie boosts",
  ["doubledrop"] = "Enemies drop double loot when killed",
  ["buildmaster"] = "Crafting items costs half the materials",
  ["refresh"] = "Food and items in your inventory slowly regain freshness",
  ["reader"] = "Craft and read all books (Wickerbottom), including the old horticulture tome",
  ["justicerain"] = "Unlock Wickerbottom's three extra exclusive books",
  ["supply"] = "Build precise supply items and antler decorations",
  ...
  ["ancientstation"] = "Build an ancient pseudoscience station to unlock ancient tech on the spot",
  ["autorepair"] = "Equipped ordinary items slowly repair their own durability",
  ["magicpepair"] = "Equipped magical items slowly repair their own durability",
  ["ignorestorm"] = "Walk freely through summer desert sandstorms, unaffected",
  ["moonstone"] = "Build moon platforms",
  ["timemanager"] = "Gain Wanda's time-management kit: pocket watches, rewind/teleport and more",
  ["alchemytechnology"] = "Gain Wilson's alchemy tech, unlocking transmutation recipes",
